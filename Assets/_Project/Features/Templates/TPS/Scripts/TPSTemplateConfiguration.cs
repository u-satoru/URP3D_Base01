...
namespace asterivo.Unity60.Features.Templates.TPS
{
    ...
    public class TPSTemplateConfiguration : ScriptableObject
    {
        ...
        public void SetupPlayerController(GameObject player)
        {
            ...
            // Cover System (placeholder - implement when TPSCoverSystem is available)
            ...
            // Health System (placeholder - implement when TPSHealthSystem is available)
            // SetupHealthSystem(player);

            // Animation Controller (placeholder - implement when TPSAnimationController is available)
        ...
        {
            var cmBrain = UnityEngine.Camera.main?.GetComponent<Unity.Cinemachine.CinemachineBrain>();
            if (cmBrain == null)
            {
        ...
        private void CreateVirtualCamera(string cameraName, GameObject player, CameraType type)
        {
            ...
            var vcam = vcamGO.AddComponent<Unity.Cinemachine.CinemachineVirtualCamera>();
            ...
            switch (type)
            {
                case CameraType.Normal:
                    var composer = vcam.AddCinemachineComponent<Unity.Cinemachine.Cinemachine3rdPersonFollow>();
                ...
                case CameraType.Aim:
                    var aimComposer = vcam.AddCinemachineComponent<Unity.Cinemachine.Cinemachine3rdPersonFollow>();
                ...
                case CameraType.Cover:
                    var coverComposer = vcam.AddCinemachineComponent<Unity.Cinemachine.Cinemachine3rdPersonFollow>();
        ...
        /// <summary>
        /// ヘルス・アーマーシステムの設定 (placeholder - implement when TPSHealthSystem is available)
        /// </summary>
        private void SetupHealthSystem(GameObject player)
        {
            // Placeholder implementation
            Debug.Log("[TPSTemplate] Health System setup (placeholder - TPSHealthSystem not implemented yet)");
        ...
        /// <summary>
        /// アニメーションコントローラーの設定 (placeholder - implement when TPSAnimationController is available)
        /// </summary>
        private void SetupAnimationController(GameObject player)
        {
            ...
            Debug.Log("[TPSTemplate] Animation Controller setup (placeholder - TPSAnimationController not implemented yet)");
        ...
        public void SetupWeaponSystem(GameObject player)
        {
            ...
            // Weapon Manager (placeholder - implement when TPSWeaponManager is available)
            Debug.Log("[TPSTemplate] Weapon Manager setup (placeholder - TPSWeaponManager not implemented yet)");
        ...
        public void SetupEnemySystem(GameObject[] enemies)
        {
            ...
            foreach (var enemy in enemies)
            {
                ...
                // TPS Enemy Controller (placeholder - implement when TPSEnemyController is available)
                Debug.Log($"[TPSTemplate] Enemy Controller setup (placeholder - TPS enemy systems not implemented yet) for {enemy.name}");
                ...
                // Health System for enemies (placeholder - implement when TPSHealthSystem is available)
                ...
                // Cover usage for enemies (placeholder - implement when TPSEnemyCoverSystem is available)
