...
namespace asterivo.Unity60.Features.AI.Configuration
{
    /// <summary>
    /// AI検出システムのパラメータを定義するScriptableObject設定クラス
    /// </summary>
    /// <remarks>
    /// 設計思想：
    /// このクラスは、AI層の検出システムの全てのパラメータを一元管理し、
    ...
    /// - AI層独自の設定として定義
    /// - 他のFeature層への依存なし
    /// - GameEventを通じて検出結果を通知
    /// </remarks>
    [CreateAssetMenu(menuName = "asterivo/AI/Detection Config", fileName = "AIDetectionConfig")]
    public class AIDetectionConfiguration : ScriptableObject
    {
