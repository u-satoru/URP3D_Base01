...
namespace asterivo.Unity60.Core.Audio
{
    ...
    public class AmbientManager : MonoBehaviour
    {
        ...
        // 繧ｪ繝ｼ繝・ぅ繧ｪ繧ｽ繝ｼ繧ｹ邂｡逅・        private AudioSource[] ambientSources;
        ...
        /// <summary>
        /// 迺ｰ蠅・浹繝槭ロ繝ｼ繧ｸ繝｣繝ｼ縺ｮ蛻晄悄蛹・        /// </summary>
        ...
        private void SetupAudioSources()
        {
            for (int i = 0; i < ambientSourceCount; i++)
            {
                ...
                source.loop = true;
                source.spatialBlend = 0f; // 迺ｰ蠅・浹縺ｯ騾壼ｸｸ2D
        ...
        /// <summary>
        /// 迚ｹ螳壻ｽ咲ｽｮ縺ｧ縺ｮ迺ｰ蠅・浹繝槭せ繧ｭ繝ｳ繧ｰ蠑ｷ蠎ｦ繧貞叙蠕・        /// </summary>
        ...
        {
            // 蜿､縺・Ξ繧､繝､繝ｼ縺ｮ繝輔ぉ繝ｼ繝峨い繧ｦ繝茨ｼ亥酔縺倥ち繧､繝励′縺ゅｌ縺ｰ・・            var existingLayer = activeLayers.Find(layer => layer.layerType == newLayer.layerType);
            ...
            if (targetClip != null)
            {
                ...
                // 繧ｹ繝・Ν繧ｹ髻ｳ髻ｿ繧､繝吶Φ繝医・逋ｺ陦・                if (ambientSoundTriggeredEvent != null)
                {
        ...
        private void UpdateMaskingEffects()
        {
            ...
            // 螳溯｣・・ StealthAudioCoordinator 縺ｨ縺ｮ騾｣謳ｺ縺ｧ陦後≧
        }
        ...
        /// <summary>
        /// 蛻ｩ逕ｨ蜿ｯ閭ｽ縺ｪ迺ｰ蠅・浹繧ｽ繝ｼ繧ｹ繧貞叙蠕・        /// </summary>
        private AudioSource GetAvailableAmbientSource()
        {
            // 菴ｿ逕ｨ荳ｭ縺ｧ縺ｪ縺・た繝ｼ繧ｹ繧呈､懃ｴ｢
            foreach (var source in ambientSources)
            {
                if (!source.isPlaying)
                {
            ...
            // 蜈ｨ縺ｦ菴ｿ逕ｨ荳ｭ縺ｮ蝣ｴ蜷医・譛繧ょ商縺・ｂ縺ｮ繧堤ｽｮ縺肴鋤縺・            return ambientSources[0];
        }

        /// <summary>
        /// 繝ｬ繧､繝､繝ｼ縺九ｉ繧ｯ繝ｪ繝・・繧貞叙蠕・        /// </summary>
        ...
        private void UpdateTimeBasedAmbient()
        {
            ...
            {
                // 譎る俣蟶ｯ縺ｮ迺ｰ蠅・浹縺ｯ菴主━蜈亥ｺｦ縺ｧ閭梧勹縺ｫ霑ｽ蜉
