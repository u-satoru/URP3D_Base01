...
namespace asterivo.Unity60.Core.Audio.Controllers
{
    ...
    /// AmbientManager縺九ｉ蛻・屬縺輔ｌ縺溷､ｩ豌鈴浹髻ｿ蟆ら畑繧ｳ繝ｳ繝医Ο繝ｼ繝ｩ繝ｼ
    /// </summary>
    public class WeatherAmbientController : MonoBehaviour
    {
        ...
        // 蜀・Κ迥ｶ諷・        private AudioSource[] weatherSources;
        ...
        private IEnumerator WeatherTransitionCoroutine(WeatherType newWeather)
        {
            ...
            // 蛻ｩ逕ｨ蜿ｯ閭ｽ縺ｪ繧ｪ繝ｼ繝・ぅ繧ｪ繧ｽ繝ｼ繧ｹ繧呈爾縺・            AudioSource availableSource = GetAvailableWeatherSource();
            ...
            // 蜿､縺・Ξ繧､繝､繝ｼ繧偵ヵ繧ｧ繝ｼ繝峨い繧ｦ繝・            var layersToRemove = new List<WeatherAmbientLayer>(activeWeatherLayers);
        ...
        private AudioSource GetAvailableWeatherSource()
        {
            ...
            return weatherSources[0]; // 蜈ｨ縺ｦ菴ｿ逕ｨ荳ｭ縺ｮ蝣ｴ蜷医・譛蛻昴・繧ゅ・繧剃ｽｿ逕ｨ
        }
        ...
        /// <summary>
        /// 譁ｰ縺励＞螟ｩ豌励Ξ繧､繝､繝ｼ縺ｸ縺ｮ繧ｯ繝ｭ繧ｹ繝輔ぉ繝ｼ繝・        /// </summary>
        ...
        /// <summary>
        /// 螟ｩ豌励Ξ繧､繝､繝ｼ縺ｮ繝輔ぉ繝ｼ繝峨い繧ｦ繝・        /// </summary>
        ...
        /// <summary>
        /// 螟ｩ豌怜挨迺ｰ蠅・浹繧ｳ繝ｬ繧ｯ繧ｷ繝ｧ繝ｳ・・eatherAmbientController蟆ら畑・・        /// </summary>
        [System.Serializable]
        private class WeatherAmbientCollection
        {
            ...
            /// <summary>
            /// 繝ｩ繝ｳ繝繝縺ｪ繧ｪ繝ｼ繝・ぅ繧ｪ繧ｯ繝ｪ繝・・繧貞叙蠕・            /// </summary>
