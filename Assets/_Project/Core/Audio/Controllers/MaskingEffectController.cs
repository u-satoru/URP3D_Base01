...
{
    /// <summary>
    /// 繧ｹ繝・Ν繧ｹ繧ｲ繝ｼ繝逕ｨ繝槭せ繧ｭ繝ｳ繧ｰ蜉ｹ譫懷宛蠕｡繧ｷ繧ｹ繝・Β
    /// AmbientManager縺九ｉ蛻・屬縺輔ｌ縺溘・繧ｹ繧ｭ繝ｳ繧ｰ蜉ｹ譫懷ｰら畑繧ｳ繝ｳ繝医Ο繝ｼ繝ｩ繝ｼ
    /// </summary>
    public class MaskingEffectController : MonoBehaviour
    {
        ...
        // 繝槭せ繧ｭ繝ｳ繧ｰ邂｡逅・        private List<MaskingAudioSource> trackingAudioSources = new List<MaskingAudioSource>();
        ...
        /// <summary>
        /// 繧ｰ繝ｭ繝ｼ繝舌Ν繝槭せ繧ｭ繝ｳ繧ｰ蠑ｷ蠎ｦ縺ｮ險ｭ螳・        /// </summary>
        ...
        public void StopAllMaskingEffects()
        {
            ...
            // 蜈ｨAudioSource縺ｮ繝槭せ繧ｭ繝ｳ繧ｰ蜉ｹ譫懊ｒ繝ｪ繧ｻ繝・ヨ
        ...
        private void StartMaskingDetection()
        {
            // 笨・ServiceLocator蟆ら畑螳溯｣・- IAudioUpdateService繧貞叙蠕・            if (asterivo.Unity60.Core.FeatureFlags.UseServiceLocator)
            {
                try
                {
                    ...
                    {
                        // 蜊碑ｪｿ譖ｴ譁ｰ繧ｷ繧ｹ繝・Β縺ｫ逋ｻ骭ｲ・医う繝吶Φ繝磯ｧ・虚・・                        coordinator.OnAudioSystemSync += OnAudioSystemSync;
        ...
        {
            // 笨・ServiceLocator蟆ら畑螳溯｣・- IAudioUpdateService縺九ｉ縺ｮ逋ｻ骭ｲ隗｣髯､
        ...
        /// <summary>
        /// AudioSource縺後・繧ｹ繧ｭ繝ｳ繧ｰ蟇ｾ雎｡縺ｨ縺励※譛牙柑縺九メ繧ｧ繝・け
        /// </summary>
        private bool IsValidMaskingSource(AudioSource audioSource)
        {
            ...
            // 髻ｳ驥上メ繧ｧ繝・け・磯撼蟶ｸ縺ｫ蟆上＆縺・浹縺ｯ髯､螟厄ｼ・            bool hasAudibleVolume = audioSource.volume > AudioConstants.MIN_AUDIBLE_VOLUME;
            
            return hasValidTag && hasValidLayer && hasAudibleVolume;
        }

        /// <summary>
        /// 繝槭せ繧ｭ繝ｳ繧ｰ蜉ｹ譫懊・蜃ｦ逅・        /// </summary>
        private void ProcessMaskingEffects()
        {
            ...
            if (trackingAudioSources.Count > 0)
            {
                ...
                // 譛繧ょｼｷ縺・・繧ｹ繧ｭ繝ｳ繧ｰ蜉ｹ譫懊ｒ蜿門ｾ・                currentMaskingStrength = trackingAudioSources.Max(source => source.maskingStrength);
            ...
            // 繝槭せ繧ｭ繝ｳ繧ｰ髻ｳ髻ｿ讀懷・繧､繝吶Φ繝・            if (isMaskingActive && maskingSoundDetectedEvent != null)
            {
        ...
        /// <summary>
        /// AudioSource縺ｮ蜈・・髻ｳ驥上ｒ蜿門ｾ・        /// </summary>
        private float GetOriginalVolume(AudioSource audioSource)
        {
            // 蜈・・髻ｳ驥上・菫晏ｭ倥＠縺ｦ縺・↑縺・◆繧√∫樟蝨ｨ縺ｮ髻ｳ驥上ｒ蝓ｺ貅悶→縺吶ｋ
            // 螳滄圀縺ｮ繝励Ο繧ｸ繧ｧ繧ｯ繝医〒縺ｯ縲、udioSource縺ｮ蜈・ョ繝ｼ繧ｿ繧剃ｿ晄戟縺吶ｋ莉慕ｵ・∩縺悟ｿ・ｦ・            return Mathf.Max(audioSource.volume, 0.1f);
        }

        /// <summary>
        /// AudioSource縺ｮ髻ｳ驥上ｒ蜈・↓謌ｻ縺・        /// </summary>
        private void RestoreOriginalVolume(AudioSource audioSource)
        {
            // 螳溯｣・・蜈・・髻ｳ驥上ョ繝ｼ繧ｿ菫晄戟譁ｹ豕輔↓萓晏ｭ・            // 縺薙％縺ｧ縺ｯ邁｡蜊倥↑蠕ｩ蜈・・逅・            if (maskingStrengthCache.ContainsKey(audioSource))
            {
        ...
        {
            // 蜉ｹ邇・噪縺ｪ繝槭せ繧ｭ繝ｳ繧ｰ蜃ｦ逅・ｼ域里縺ｫ譛驕ｩ蛹悶＆繧後◆繝・・繧ｿ繧剃ｽｿ逕ｨ・・            if (syncData.nearbyAudioSources.Count > 0)
            {
        ...
        private void OnDrawGizmosSelected()
        {
            ...
            // 繧｢繧ｯ繝・ぅ繝悶↑繝槭せ繧ｭ繝ｳ繧ｰ繧ｽ繝ｼ繧ｹ縺ｮ蜿ｯ隕門喧
            if (isMaskingActive)
            {
