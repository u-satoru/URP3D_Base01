...
namespace asterivo.Unity60.Core.Audio
{
    ...
    public class BGMManager : MonoBehaviour
    {
        ...
        {
            // Primary BGM Sourceが未設定の場合は新規作成
            ...
            // Crossfade BGM Sourceが未設定の場合は新規作成
        ...
        private void ConfigureAudioSource(AudioSource source)
        {
            ...
            source.spatialBlend = 0f; // 2D音声
            source.loop = true;
            source.outputAudioMixerGroup = bgmMixerGroup;
            source.priority = 64; // 音声の優先度
        }

        /// <summary>
        /// 必要なシステムコンポーネントの参照を取得
        /// </summary>
        ...
        {
            // AudioLowPassFilter と AudioReverbFilter を適用
            // 環境音に応じたフィルターを適用
        }
    ...
    public class BGMTrack
    {
        ...
        [Range(0f, 1f)] public float tensionLevel = 0f;           // 現在の緊張レベル
        public bool allowInStealthMode = true;                    // ステルスモードでの再生を許可
        [Header("Environmental Context")]
        public EnvironmentType[] suitableEnvironments;            // 適切な環境
        public WeatherType[] suitableWeather;                     // 適切な天候
        public TimeOfDay[] suitableTimeOfDay;                     // 適切な時間帯
