...
{
    /// <summary>
    /// 繧ｹ繝・Ν繧ｹ繧ｲ繝ｼ繝迚ｹ蛹悶・BGM繝槭ロ繝ｼ繧ｸ繝｣繝ｼ
    ...
    public class BGMManager : MonoBehaviour
    {
        ...
        [SerializeField, Required] private BGMTrack[] ambientBGM;        // 蟷ｳ蟶ｸ譎・        [SerializeField, Required] private BGMTrack[] tensionBGM;        // 隴ｦ謌呈凾
        [SerializeField, Required] private BGMTrack[] combatBGM;         // 謌ｦ髣俶凾
        [SerializeField] private BGMTrack[] stealthSuccessBGM;           // 繧ｹ繝・Ν繧ｹ謌仙粥譎・        [SerializeField] private BGMTrack[] explorationBGM;              // 謗｢邏｢譎・
        ...
        // 蜀・Κ迥ｶ諷・        private Dictionary<BGMCategory, BGMTrack[]> bgmCategories;
        ...
        /// <summary>
        /// BGM繝槭ロ繝ｼ繧ｸ繝｣繝ｼ縺ｮ蛻晄悄蛹・        /// </summary>
        private void InitializeBGMManager()
        {
            // BGM繧ｫ繝・ざ繝ｪ霎樊嶌縺ｮ讒狗ｯ・            bgmCategories = new Dictionary<BGMCategory, BGMTrack[]>
            {
        ...
        /// <summary>
        /// 繧ｪ繝ｼ繝・ぅ繧ｪ繧ｽ繝ｼ繧ｹ縺ｮ蜈ｱ騾夊ｨｭ螳・        /// </summary>
        ...
        /// <summary>
        /// 邱雁ｼｵ蠎ｦ縺九ｉBGM繧ｫ繝・ざ繝ｪ繧呈ｱｺ螳・        /// </summary>
        ...
        private BGMTrack SelectBGMByCategory(BGMCategory category)
        {
            ...
            // 迺ｰ蠅・・螟ｩ蛟吶・譎る俣蟶ｯ縺ｫ驕ｩ縺励◆繝医Λ繝・け繧貞━蜈磯∈謚・            var suitableTracks = FilterTracksByContext(tracks);
        ...
        /// <summary>
        /// 迴ｾ蝨ｨ縺ｮ繧ｳ繝ｳ繝・く繧ｹ繝医↓驕ｩ縺励◆繝医Λ繝・け繧偵ヵ繧｣繝ｫ繧ｿ繝ｪ繝ｳ繧ｰ
        /// </summary>
        ...
        private IEnumerator CrossfadeCoroutine(BGMTrack newTrack)
        {
            ...
            // 繧ｯ繝ｭ繧ｹ繝輔ぉ繝ｼ繝臥畑繧ｽ繝ｼ繧ｹ縺ｫ譁ｰ縺励＞繝医Λ繝・け繧定ｨｭ螳・            crossfadeBGMSource.clip = newTrack.clip;
            ...
            // 繧ｽ繝ｼ繧ｹ繧貞・繧梧崛縺・            var tempSource = primaryBGMSource;
        ...
        /// <summary>
        /// 謖・ｮ壹＠縺檻GM蜷阪′迴ｾ蝨ｨ蜀咲函荳ｭ縺狗｢ｺ隱・        /// </summary>
        public bool IsPlaying(string bgmName)
        {
            if (!IsPlaying() || currentTrack == null)
                return false;
                
            // BGM蜷阪〒縺ｮ繝槭ャ繝√Φ繧ｰ・育ｰ｡逡･螳溯｣・ｼ・            return currentTrack.clip != null && 
                   (currentTrack.clip.name.Contains(bgmName) || 
                    currentTrack.trackName.Contains(bgmName));
        }
        
        /// <summary>
        /// 謖・ｮ壹＠縺檻GM繧ｫ繝・ざ繝ｪ縺檎樟蝨ｨ蜀咲函荳ｭ縺狗｢ｺ隱・        /// </summary>
        ...
        /// <summary>
        /// 迴ｾ蝨ｨ縺ｮBGM繝医Λ繝・け諠・ｱ繧貞叙蠕・        /// </summary>
    ...
    public class BGMTrack
    {
        ...
        [Range(0f, 1f)] public float tensionLevel = 0f;           // 縺薙・譖ｲ縺碁←逕ｨ縺輔ｌ繧狗ｷ雁ｼｵ蠎ｦ
        public bool allowInStealthMode = true;                    // 繧ｹ繝・Ν繧ｹ荳ｭ縺ｫ蜀咲函蜿ｯ閭ｽ縺・
        [Header("Environmental Context")]
        public EnvironmentType[] suitableEnvironments;            // 驕ｩ逕ｨ迺ｰ蠅・        public WeatherType[] suitableWeather;                     // 驕ｩ逕ｨ螟ｩ蛟・        public TimeOfDay[] suitableTimeOfDay;                     // 驕ｩ逕ｨ譎る俣蟶ｯ
