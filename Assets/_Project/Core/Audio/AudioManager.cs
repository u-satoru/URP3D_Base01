...
namespace asterivo.Unity60.Core.Audio
{
    ...
    public class AudioManager : MonoBehaviour, IAudioService, IInitializable
    {
        ...
        /// <summary>
        /// IInitializable螳溯｣・- 繧ｪ繝ｼ繝・ぅ繧ｪ繝槭ロ繝ｼ繧ｸ繝｣繝ｼ縺ｮ蛻晄悄蛹・
        /// </summary>
        ...
        private void InitializeAudioUpdateCoordinator()
        {
            ...
            if (FeatureFlags.UseServiceLocator)
            {
                // TODO: AudioUpdateCoordinator逕ｨ縺ｮ繧､繝ｳ繧ｿ繝ｼ繝輔ぉ繝ｼ繧ｹ繧剃ｽ懈・蠕後↓譛牙柑蛹・
        ...
        {
            // EffectManager縺ｫ縺ｯ蛟句挨縺ｮ迥ｶ諷九メ繧ｧ繝・け讖溯・縺後↑縺・◆繧√∽ｻｮ螳溯｣・
            // TODO: 蛟句挨繧ｵ繧ｦ繝ｳ繝峨・蜀咲函迥ｶ諷九ヨ繝ｩ繝・く繝ｳ繧ｰ讖溯・繧定ｿｽ蜉
            return false;
        }
